...
static_assert(StdLegacyBidirectionalIteratorTraits::is_std_legacy_bidirectional_iterator<std::array<int, 16>::iterator>, "std::array のイテレータは LegacyBidirectionalIterator を満たしますが、識別結果は false を返しました。");
static_assert(StdLegacyRandomAccessIteratorTraits::is_std_legacy_random_access_iterator<std::array<int, 16>::iterator>, "std::array のイテレータは LegacyRandomAccessIterator を満たしますが、識別結果は false を返しました。");
...
static_assert(StdLegacyBidirectionalIteratorTraits::is_std_legacy_bidirectional_iterator<std::vector<int>::iterator>, "std::vector のイテレータは LegacyBidirectionalIterator を満たしますが、識別結果は false を返しました。");
static_assert(StdLegacyRandomAccessIteratorTraits::is_std_legacy_random_access_iterator<std::vector<int>::iterator>, "std::vector のイテレータは LegacyRandomAccessIterator を満たしますが、識別結果は false を返しました。");
...
static_assert(StdLegacyBidirectionalIteratorTraits::is_std_legacy_bidirectional_iterator<std::deque<int>::iterator>, "std::deque のイテレータは LegacyBidirectionalIterator を満たしますが、識別結果は false を返しました。");
static_assert(StdLegacyRandomAccessIteratorTraits::is_std_legacy_random_access_iterator<std::deque<int>::iterator>, "std::deque のイテレータは LegacyRandomAccessIterator を満たしますが、識別結果は false を返しました。");
...
static_assert(StdLegacyBidirectionalIteratorTraits::is_std_legacy_bidirectional_iterator<std::list<int>::iterator>, "std::list のイテレータは LegacyBidirectionalIterator を満たしますが、識別結果は false を返しました。");
static_assert(!StdLegacyRandomAccessIteratorTraits::is_std_legacy_random_access_iterator<std::list<int>::iterator>, "std::list のイテレータは LegacyRandomAccessIterator を満たしませんが、識別結果は true を返しました。");

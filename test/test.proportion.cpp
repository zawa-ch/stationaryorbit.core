...
std::array<std::function<int(void)>, 37> tests =
{
	[]()
	{
		...
		return check_if(Traits::IsNumericalType<Proportion1_t>);
	},
	[]()
	{
	...
	[]()
	{
		...
		return check_if(!Traits::IsIntegralType<Proportion1_t>);
	},
	[]()
	{
		std::cout << "4. Type Proportion1_t meets the traits Comparable?";
		return check_if(Traits::IsComparable<Proportion1_t>);
	},
	[]()
	{
	...
	[]()
	{
		...
		return check_if(Traits::IsNumericalType<Proportion8_t>);
	},
	[]()
	{
	...
	[]()
	{
		...
		return check_if(!Traits::IsIntegralType<Proportion8_t>);
	},
	[]()
	{
		std::cout << "9. Type Proportion8_t meets the traits Comparable?";
		return check_if(Traits::IsComparable<Proportion8_t>);
	},
	[]()
	{
	...
	[]()
	{
		...
		return check_if(Traits::IsNumericalType<Proportion16_t>);
	},
	[]()
	{
	...
	[]()
	{
		...
		return check_if(!Traits::IsIntegralType<Proportion16_t>);
	},
	[]()
	{
		std::cout << "14. Type Proportion16_t meets the traits Comparable?";
		return check_if(Traits::IsComparable<Proportion16_t>);
	},
	[]()
	{
	...
	[]()
	{
		...
		return check_if(Traits::IsNumericalType<Proportion32_t>);
	},
	[]()
	{
	...
	[]()
	{
		...
		return check_if(!Traits::IsIntegralType<Proportion32_t>);
	},
	[]()
	{
		std::cout << "19. Type Proportion32_t meets the traits Comparable?";
		return check_if(Traits::IsComparable<Proportion32_t>);
	},
	[]()
	{
	...
	[]()
	{
		...
		return check_if(Traits::IsNumericalType<Proportion64_t>);
	},
	[]()
	{
	...
	[]()
	{
		...
		return check_if(!Traits::IsIntegralType<Proportion64_t>);
	},
	[]()
	{
		std::cout << "24. Type Proportion64_t meets the traits Comparable?";
		return check_if(Traits::IsComparable<Proportion64_t>);
	},
	[]()
	{

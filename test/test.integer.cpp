...
std::array<std::function<int(void)>, 23> tests =
{
	[]()
	{
		...
		return check_if(IntegralTypeTraits::is_integraltype<Integer<std::byte>>);
	},
	[]()
	{
		std::cout << "2. Type Integer<uint8_t> meets the traits IntegralType?";
		return check_if(IntegralTypeTraits::is_integraltype<Integer<uint8_t>>);
	},
	[]()
	{
		std::cout << "3. Type Integer<uint16_t> meets the traits IntegralType?";
		return check_if(IntegralTypeTraits::is_integraltype<Integer<uint16_t>>);
	},
	[]()
	{
		std::cout << "4. Type Integer<uint32_t> meets the traits IntegralType?";
		return check_if(IntegralTypeTraits::is_integraltype<Integer<uint32_t>>);
	},
	[]()
	{
		std::cout << "5. Type Integer<uint64_t> meets the traits IntegralType?";
		return check_if(IntegralTypeTraits::is_integraltype<Integer<uint64_t>>);
	},
	[]()
	{
		std::cout << "6. Type SignedInteger<std::byte> meets the traits IntegralType?";
		return check_if(IntegralTypeTraits::is_integraltype<SignedInteger<std::byte>>);
	},
	[]()
	{
		std::cout << "7. Type SignedInteger<uint8_t> meets the traits IntegralType?";
		return check_if(IntegralTypeTraits::is_integraltype<SignedInteger<uint8_t>>);
	},
	[]()
	{
		std::cout << "8. Type SignedInteger<uint16_t> meets the traits IntegralType?";
		return check_if(IntegralTypeTraits::is_integraltype<SignedInteger<uint16_t>>);
	},
	[]()
	{
		std::cout << "9. Type SignedInteger<uint32_t> meets the traits IntegralType?";
		return check_if(IntegralTypeTraits::is_integraltype<SignedInteger<uint32_t>>);
	},
	[]()
	{
		std::cout << "10. Type SignedInteger<uint64_t> meets the traits IntegralType?";
		return check_if(IntegralTypeTraits::is_integraltype<SignedInteger<uint64_t>>);
	},
	[]()
	{

...
namespace zawa_ch::StationaryOrbit
{
	...
	public:
		...
		template<class T, std::enable_if_t<BitSequenceTypeTraits::is_bitsequence_type<T>, int> = 0>
	...
	{
		static_assert(BitSequenceTypeTraits::is_bitsequence_type<T>, "ビット幅の計数は整数型、boolなどの固定幅のビットシーケンスでのみ有効です。");
	};

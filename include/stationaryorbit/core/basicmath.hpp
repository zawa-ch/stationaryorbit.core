...
namespace zawa_ch::StationaryOrbit
{
	...
	public:
		...
		template<class Tp, std::enable_if_t<(NumericalTypeTraits::IsIntegralType<Tp>), int> = 0>
		[[nodiscard]] static constexpr Tp ceil(const Tp& value) { return value; }
		///	指定された値を指定された値より大きい整数に丸めます
		template<class Tp, std::enable_if_t<!(NumericalTypeTraits::IsIntegralType<Tp>) && (is_std_ceil_callable<Tp>), int> = 0>
		...
		///	指定された値を指定された値より小さい整数に丸めます
		template<class Tp, std::enable_if_t<!(NumericalTypeTraits::IsIntegralType<Tp>) && (is_std_floor_callable<Tp>), int> = 0>
		...
		///	指定された値を0に近い整数に丸めます
		template<class Tp, std::enable_if_t<!(NumericalTypeTraits::IsIntegralType<Tp>) && (is_std_trunc_callable<Tp>), int> = 0>
		...
		///	指定された値を最も近い整数に丸めます
		template<class Tp, std::enable_if_t<!(NumericalTypeTraits::IsIntegralType<Tp>) && (is_std_round_callable<Tp>), int> = 0>

...
namespace zawa_ch::StationaryOrbit
{
	...
	public:
		...
		template<class fromT, std::enable_if_t< !(std::is_same_v<ValueType, fromT> || std::is_convertible_v<ValueType, fromT> || TypeTraitsBase::is_aggregatable<ValueType, fromT>) && IntegralTypeTraits::is_integraltype<fromT> && !std::numeric_limits<fromT>::is_signed, int> = 0>

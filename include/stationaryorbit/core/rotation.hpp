...
namespace zawa_ch::StationaryOrbit
{
	...
	struct Rotation
	{
		static_assert(NumericalTraits::IsIntegralType<Tp> && BitSequenceTraits::IsBitSequenceType<Tp>, "テンプレート引数 Tp は、型要件:IntegralType と型要件:BitSequenceType をともに満たす必要があります。");
	private:
		Tp _value;
